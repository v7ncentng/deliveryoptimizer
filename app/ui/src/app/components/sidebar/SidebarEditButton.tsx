...
export default function SidebarEditButton() {
  ...
  return (
    <Link
      href="/edit"
      className={isActive ? SIDEBAR_NAV_ITEM_ACTIVE : SIDEBAR_NAV_ITEM_INACTIVE}
    >
      <span
        className={
          isActive ? SIDEBAR_NAV_PILL_ACTIVE : SIDEBAR_NAV_PILL_INACTIVE
        }
      >
        {SVG_EDIT_ICON}
      </span>
      <span
        className={
          isActive ? SIDEBAR_NAV_LABEL_ACTIVE : SIDEBAR_NAV_LABEL_INACTIVE
        }
      >
        Manage
      </span>
