...
import { VEHICLE_ROW_ICON_BUTTON } from "../formStyles.v2";
...
export function DeleteIconButton({ name, onClick }: DeleteIconButtonProps) {
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
        <path d="M15 29C14.45 29 13.9792 28.8042 13.5875 28.4125C13.1958 28.0208 13 27.55 13 27V14H12V12H17V11H23V12H28V14H27V27C27 27.55 26.8042 28.0208 26.4125 28.4125C26.0208 28.8042 25.55 29 25 29H15ZM25 14H15V27H25V14ZM17 25H19V16H17V25ZM21 25H23V16H21V25Z" 
          fill="var(--edit-row-icon)"/>
      </svg>
    </button>
  );
